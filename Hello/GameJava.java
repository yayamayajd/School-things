...
public class GameJava {
...

    {
        ...
        System.out.println("""welcome to my game:try to guess which number that in jiadai's mind now.
                             ...
                             You need input 3 numbers.
                
                
                             If the number is right in the right position, you will get 1'O'.
                             if the number is right but in wrong position, you will get 1'A', if the number i
                             s totolly wrong,you will get 1'O'.
...
//        }
            ...
            if (result != "OOO" && counter >= 7) ;
            {
                ...
                System.out.println("""Correct!!!!!
                        Congratulations! You are the one in the world who knows Jiadai most!
                        Jiadai is super happy! You make Jiadai a daaaaaaaaay!""");
            }
        }
    }
}
